...
ppListRIterator+<int;>; // Целочисленная специализация итератора
...
int main(void) {
    ...
    print_test_results(val == 99, "rbegin points to 99 (tail)");
    printf("\n");
    ...
    ppList_RBEGIN(l, rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(val == 40, "rbegin points to last element (40)");
    printf("\n-------------------------------------------\n\n");
    ...
    ppList_REND(l, rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(val == 55, "rend points to 55 (head)");
    printf("\n");
    ...
    ppList_REND(l, rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(val == 1, "rend points to first element (1)");
    printf("\n-------------------------------------------\n\n");
    ...
    print_test_results(rit.node == NULL, "node is NULL");
    printf("\n");
    ...
    ppList_CURRENT_RITERATOR(l, rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(val == 77, "current_riterator points to 77 (tail)");
    printf("\n");
    ...
    ppList_CURRENT_RITERATOR(l, rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(val == 100, "current_riterator points to head (100)");
    printf("\n");
    ...
    ppList_CURRENT_RITERATOR(l, rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(val == 300, "current_riterator points to tail (300)");
    printf("\n-------------------------------------------\n\n");
    ...
    print_test_results(res == 0 && rit.node == NULL, "returns 0, node stays NULL");
    printf("\n");
    ...
    print_test_results(res == 1 && rit.node == NULL, "returns 1, node becomes NULL");
    printf("\n");
    ...
    res = ppListRIterator_next((ppListRIterator*)&rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(res == 1 && val == 7, "first next -> 7, returns 1");
    res = ppListRIterator_next((ppListRIterator*)&rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(res == 1 && val == 6, "second next -> 6, returns 1");
    res = ppListRIterator_next((ppListRIterator*)&rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(res == 1 && val == 5, "third next -> 5, returns 1");
    res = ppListRIterator_next((ppListRIterator*)&rit);
    print_test_results(res == 1 && rit.node == NULL, "fourth next -> 1, node becomes NULL");
    res = ppListRIterator_next((ppListRIterator*)&rit);
    print_test_results(res == 0 && rit.node == NULL, "fifth next -> 0, stays NULL");
    printf("\n-------------------------------------------\n\n");
    ...
    res = ppListRIterator_prev((ppListRIterator*)&rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(res == 1 && val == 6, "first prev -> 6, returns 1");
    res = ppListRIterator_prev((ppListRIterator*)&rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(res == 1 && val == 7, "second prev -> 7, returns 1");
    res = ppListRIterator_prev((ppListRIterator*)&rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(res == 1 && val == 8, "third prev -> 8, returns 1");
    res = ppListRIterator_prev((ppListRIterator*)&rit);
    print_test_results(res == 1 && rit.node == NULL, "fourth prev -> 1, node becomes NULL");
    res = ppListRIterator_prev((ppListRIterator*)&rit);
    print_test_results(res == 0 && rit.node == NULL, "fifth prev -> 0, stays NULL");
    printf("\n-------------------------------------------\n\n");
    ...
    print_test_results(v1 == 4 && v2 == 3 && v3 == 2, "get_value returns 4,3,2 correctly");
    printf("\n");
    ...
    ppList_RBEGIN(l, rit);
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(val == 4, "first get_value -> 4");
    ppListRIterator_GET_VAL(val, rit);
    print_test_results(val == 4, "second get_value still -> 4 (iterator unchanged)");
    printf("\n-------------------------------------------\n\n");
